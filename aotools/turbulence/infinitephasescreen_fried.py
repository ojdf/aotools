...
class PhaseScreen(object):
    ...
    def set_X_coords(self):
        ...
        This is always just to teh right of the existing phase. Hence the coordinate system is defined here, where
        the x co-ordinate is -1 for all points on the new phase.
        """
    ...
    def makeBMatrix(self):
        ...
        """
        # Axis 0, forwards
        self.B_mat = self.makeSingleBMatrix(
                self.cov_mat_xx, self.cov_mat_zx, self.A_mat)
    ...
    @property
    def scrn(self):
        return self._scrn[:self.nx_size]
